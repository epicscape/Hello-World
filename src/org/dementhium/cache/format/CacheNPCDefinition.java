...
public class CacheNPCDefinition {
    ...
    public static CacheNPCDefinition forID(int npcID) {
        CacheNPCDefinition npcDef = npcDefs.get(npcID);
        if (npcDef != null)
            return npcDef;
        byte[] is = null;
        try {
            is = CacheManager.getData(CacheConstants.NPCDEF_IDX_ID, npcID >>> 7, npcID & 0x7f);
        } catch (Exception e) {
    ...
    private void readValues(int opcode, RSInputStream stream) throws Exception {
        switch (opcode) {
            case 163:
                stream.readByte();
                break;
                                                                            ...
                                                                            if (opcode == 137)
                                                                                ...
                                                                                if (opcode == 140)
                                                                                    ...
                                                                                    if (opcode < 150
                                                                                                ...
                                                                                                if (opcode != 161) {
                                                                                                    if (opcode == 249) {
                                                                                                        ...
                                                                                                        for (int i_5_ = 0; i_3_ > i_5_; i_5_++) {
                                                                                                            ...
                                                                                                            if (!bool)
                                                                                                                stream.readInt();
                                                                                                                //System.out.println("Script NPC INTEGER: " + stream.readInt());
                                                                                                            else
                                                                                                                stream.readRS2String();
                                                                                                            //System.out.println("Script NPC STRING: " + stream.readRS2String());
                                                                                                        }
                                                                                                    }
                                                                                                } else
                                                                                                    aBoolean3190 = true;
                                                                                        ...
                                                                                        /*if (!((Class183) aClass183_3195).aBoolean2484)
