...
import org.dementhium.cache.stream.RSByteArrayInputStream;
...
public class CacheObjectDefinition {
    ...
    private static HashMap<Integer, CacheObjectDefinition> objDefs = new HashMap<Integer, CacheObjectDefinition>();
                                                                                                                                                ...
                                                                                                                                                if (opcode == 167)
                                                                                                                                                    ...
                                                                                                                                                    if (opcode == 169) {
                                                                                                                                                        ...
                                                                                                                                                        for (int i_60_ = 0; i_60_ < i_58_; i_60_++) {
                                                                                                                                                            ...
                                                                                                                                                            stream.read24BitInt();
                                                                                                                                                            //int length = stream.read24BitInt();
                                                                                                                                                            if (!bool)
                                                                                                                                                                stream.readInt();
                                                                                                                                                            else
    ...
    public static CacheObjectDefinition forId(int objectID) {
        CacheObjectDefinition objectDef = objDefs.get(objectID);
        if (objectDef != null)
            return objectDef;
        byte[] is = null;
        try {
        ...
        objectDef = new CacheObjectDefinition();
