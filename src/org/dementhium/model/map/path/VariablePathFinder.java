 ...
 */
public class VariablePathFinder extends DefaultPathFinder {
    ...
    public PathState findPath(Mob mob, Location base, int srcX, int srcY, int dstX, int dstY, int z, int radius, boolean running, boolean ignoreLastStep, boolean moveNear) {
        ...
        int viewportDepth = Location.VIEWPORT_SIZES[mob.getViewportDepth()] >> 4;
        ...
        state.getPoints().add(Position.create(absX, absY, z));
