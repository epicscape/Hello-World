...
/**
 * Handles the casting of the Earth bolt spell.
 * @author Emperor
 *
 */
public class EarthBolt extends MagicSpell {
	...
	public boolean castSpell(Interaction interaction) {
		...
		ProjectileManager.sendProjectile(Projectile.create(interaction.getSource(), interaction.getVictim(), 2719, 38, 32, 54, speed, 0, 124));
		interaction.getSource().animate(14209);
		interaction.getSource().graphics(2714, 0);
		interaction.setEndGraphic(Graphic.create(2724, 96 << 16));
		return true;
	}
	...
	public Item[] getRequiredRunes() {
		return new Item[] { new Item(556, 2), new Item(557, 3), new Item(562, 1) };
	}
}